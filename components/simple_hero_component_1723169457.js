...
*/
Vue.component("simple_hero_component_1723169457", {
    template: `
        <section id="hero-section" class="bg-gradient-to-br from-pink-500 to-purple-700 dark:from-pink-800 dark:to-purple-900 flex-1">
            <div id="hero-container" class="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
                <div id="hero-text-container" class="mr-auto place-self-center lg:col-span-7 bg-white bg-opacity-20 backdrop-filter backdrop-blur-lg rounded-lg p-8 shadow-lg">
                    ...
                    <div id="hero-subtitle-container" class="flex">
                        <p id="hero-subtitle" class="flex-1 max-w-2xl mb-6 font-light text-gray-100 lg:mb-8 md:text-lg lg:text-xl">Stay ahead with real-time updates on emerging blockchain technologies and trends</p>
                    </div>
